...
def handle_client(s: socket.socket, anthropic_client: Anthropic, config: Dict[str, Any], system_prompt: str) -> None:
     while True:
        try:
...
def main():
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        try:
            ...
            handle_client(s, anthropic_client, config, system_prompt)
